...
public final class JavmosGUI {
    ...
    private JPanel createControlPanel() {
        ...
        configureComponent(firstDerivativeLabel, CONTROL_PANEL_WIDTH, CONTROL_PANEL_HEIGHT / CONTROL_PANEL_ITEMS, Color.WHITE, 20, null, "", displayBackgroundColor, Color.GREEN);
